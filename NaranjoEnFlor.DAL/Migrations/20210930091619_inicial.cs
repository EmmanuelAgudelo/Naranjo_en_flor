    ...
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reservaDeMesas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_reservaDeMesas_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_reservaDeMesas_mesas_MesaId",
                        column: x => x.MesaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reservaDeMesas_MesaId",
                table: "reservaDeMesas",
                column: "MesaId");

            migrationBuilder.CreateIndex(
                name: "IX_reservaDeMesas_UsuarioId",
                table: "reservaDeMesas",
                column: "UsuarioId");
        }
